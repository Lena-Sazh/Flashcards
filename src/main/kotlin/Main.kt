...
fun main(args: Array<String>) {
    ...
    while (command != "exit") {
        ...
        if (command == "add") {
            ...
            var maxMistakes = 0
            val wordsWithMistakes = mutableListOf<String>()
            ...
            if (maxMistakes == 0) {
                ...
                println("The hardest cards are ${wordsWithMistakes.joinToString(separator = ", ") { "\"${it}\"" } }. " +
                        "You have $maxMistakes errors answering them.\n")
                log.add("The hardest cards are ${wordsWithMistakes.joinToString(separator = ", ") { "\"${it}\"" } }. " +
                        "You have $maxMistakes errors answering them.\n")
